...
import { GiBlackBook, GiBookmark } from "react-icons/gi";
import { BsBuildingFillCheck } from "react-icons/bs";
import { LuBookCopy } from "react-icons/lu";
import { FiMinus } from "react-icons/fi";

const StudentGradesModal = ({ close, data }) => {
  return (
        ...
        <div className=" inter text-lg">
          ...
          <div className="flex gap-4">
            <div className="left-col__container flex flex-col gap-4">
              ...
              <div className="details__container bg-white p-6 rounded-[4px] shadow-lg">
