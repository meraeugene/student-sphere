...
const AdminRegistrationForm = ({ toggleAddAdminState }) => {
      ...
      <div className="fixed-container z-20 h-[90vh] w-full overflow-y-scroll bg-white opacity-100 transition-all duration-300 md:w-[70%] md:border md:border-r-0 md:border-t-0 md:border-l-[#d2d2d7] lg:w-1/2 rounded-md">
        <div className="p-10 add-user__container">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl play-regular uppercase mb-6">Add Admin </h1>
            <button
          ...
          >
            ...
            <div className="flex flex-col gap-4 ">
              <button
                ...
                type="submit"
                className="bg-[#0C1E33] text-white h-[55px] rounded-md mt-2 w-[150px] inter flex items-center justify-center gap-3"
              >
                {isSubmitting ? (
                  <l-dot-pulse
                    size="38"
