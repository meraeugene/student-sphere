...
const StudentLoginForm = ({ setLoginAs }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post(
        "http://localhost/student-sphere/server/Students/loginStudent.php",
        formData
      );
    ...
    <div className="px-20">
      ...
      <div className="flex items-center gap-2 justify-center play-regular text-center text-4xl font-semibold ">
        ...
        <div className="flex items-center gap-2">
          <PiStudentFill color="#0C1E33" size={24} />
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="w-full">
              <input
                ...
                className={`${
                  errors.studentID ? "border-[2px] border-red-500" : ""
